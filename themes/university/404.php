<?php get_header();
$page_content = ot_get_option('page404_content','صفحه یافت نشد');
$layout = 'full';
?>
							...
							if(ot_get_option('page404_search','on')!='off'){
								...
								<?php else: ?>
									<form class="form-404 search-form" action="<?php echo home_url() ?>">
										<input type="text" name="s" class="form-control" placeholder="<?php echo __(' کلمه کلیدی را وارد کنید','cactusthemes');?>">
