<div class="content-pad single-event-detail">
    ...
    <div class="event-content">
        ...
        <div class="content-pad calendar-import">
            <a class="btn btn-default btn-lighter" href="https://www.google.com/calendar/render?dates=<?php echo $startdate_cal;?>/<?php echo $enddate_cal;?>&action=TEMPLATE&text=<?php echo get_the_title(get_the_ID());?>&location=<?php echo get_post_meta(get_the_ID(),'u-adress', true );?>&details=<?php echo get_the_excerpt();?>">+ تقویم گوگل</a>&nbsp;
            <a href="<?php echo home_url().'?ical_id='.get_the_ID(); ?>" class="btn btn-default btn-lighter">+ واردات </a>
            <?php // tf_events_ical();?>
        </div>
